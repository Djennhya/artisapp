...
@section('content')
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
            ...
            <div class="mt-5">
                <input type="text" class="border-0 border-bottom rounded me-5 py-3 mb-4" placeholder="Code de réduction">
                    ...
                    <div class="bg-light rounded">
                        <div class="p-4">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="">
                                    <p class="mb-0">Tarif fixe: $3.00</p>
                                </div>
                            </div>
                            <p class="mb-0 text-end">Expédition vers le RCA.</p>
                        </div>
                        ...
                        <button class="btn border-secondary rounded-pill px-4 py-3 text-primary text-uppercase mb-4 ms-4"
                            type="button">Passer à la caisse</button>
                    </div>
                </div>
            </div>
        </div>
